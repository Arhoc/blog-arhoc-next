export default function BruteForceWriteup() {
  ...
  -rw-r--r-- 1 arhoc arhoc     360 Feb 12  2022 'READ ME.txt'`
    ...
    less_txt = `<EF><BB><BF>Keywords    Date and Time   Source  Event ID        Task Category
  ...
  BTLO_Bruteforce_Challenge.txt`
    ...
    whois_json = `[arhoc@ArchLinux Bruteforce ]$ whois 113.161.192.227
  % [whois.apnic.net]
  ...
  % This query was served by the APNIC Whois Service version 1.88.25 (WHOIS-US4)`
    ...
    ports_range = `[arhoc@ArchLinux Bruteforce ]$ cat BTLO_Bruteforce_Challenge.txt | grep "Source Port" | awk "{ print \$3 }" | sort -n | head
  -
  -
  -
  -
